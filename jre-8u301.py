...
idur-pkg tmp jre
cd /tmp/idur-jre-tmp/
idur-pkg download https://github.com/idur-package/non-free-repo/releases/download/binaries/jre-8u301-linux-i586.tar.gz
tar -xvzf jre-8u301-linux-i586.tar.gz
cp -r jre1.8.0_301/ /opt/
idur-pkg read https://raw.githubusercontent.com/idur-package/media/bc4b85aa849ce60bc8ad8b93ea64b89cb97b01bb/jre-8u301/jre-8u301 > /usr/bin/jre-8u301
chmod a+x /usr/bin/jre-8u301
idur-pkg rm-tmp
